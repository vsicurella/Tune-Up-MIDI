...
class MidiProcessor : public MidiMessageCollector,
                         private AudioProcessorValueTreeState::Listener
{
    ...
    std::unique_ptr<TuneUpMidiChannelAssigner> channelAssigner;
...
public:
    ...
    MidiProcessor(AudioProcessorValueTreeState& svkTreeIn);
    ~MidiProcessor();
